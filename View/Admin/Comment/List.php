<script>
    document.title = "VQMA - Danh sách sản phẩm có bình luận";
</script>
...
<section class="mt-8 mb-2 ml-2 md:flex md:items-center md:justify-between">
    <div class="breadcumrb">
        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">Danh sách sản phẩm có bình luận</li>
        </ol>
        <h3 class="mb-0 font-bold capitalize text-2xl leading-10">Danh sách sản phẩm có bình luận</h3>
    </div>
</section>
...
<section class="w-full mx-auto">
    <div class="my-6 md:flex md:items-end md:justify-between">
        <div class="flex flex-col">
            ...
            <form action="index.php?act=list_product_comment" method="post" class="flex">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap text-center">
                                            <span><?= $so_luong_binh_luan ?></span>
                                        </td>
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <div class="flex items-center justify-center gap-x-6">
                                                <a href="<?= $URLDetailComment ?>">
