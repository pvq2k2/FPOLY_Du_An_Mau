<div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 bg-white w-full rounded-xl shadow-xl">
    <div class="text-center">
        ...
        <h1 class="mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]">404 - Không tìm thấy trang</h1>
        <p class="text-slate-600 mt-5 lg:text-lg">Trang bạn đang tìm kiếm không tồn tại hoặc đã bị loại bỏ.</p>
    </div>
</div>