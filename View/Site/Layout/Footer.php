<footer class="mt-[50px] mx-2 bg-[#0f4670] rounded-xl px-5 py-3 text-white xl:mx-auto">
    <div class="box-footer grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-2">
        ...
        <div class="text-left grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3">
            <div>
                ...
                <span class="text-center inline-block py-1 px-2 bg-white rounded text-[#0f4670] font-bold text-[18px] hover:text-white hover:bg-[#0f4670] ease-in-out duration-300">1900.0000</span>
            </div>
    ...
    <div class="info text-center pt-3">
        <p>Copyright by VANQUYETMOBIE. All rights reserved ©
            <script>
